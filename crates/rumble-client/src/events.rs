//! Backend state and commands — re-exported from rumble-protocol.
//!
//! Types have been moved to `rumble_protocol::types` for broader reuse.
//! This module re-exports them for backward compatibility.

pub use rumble_protocol::types::*;

/// Re-export ROOT_ROOM_UUID for convenience
pub use rumble_protocol::ROOT_ROOM_UUID;
